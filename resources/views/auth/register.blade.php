...
<body class="bg-bg-dark text-white min-h-screen flex items-center justify-center py-8">
<div class="w-full max-w-md">
    <div class="bg-white/5 backdrop-blur-xl border border-primary/30 rounded-2xl p-8 shadow-2xl">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-primary mb-2">Formy</h1>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-6">
            ...
            <div class="text-center">
                <p class="text-gray-400 text-sm">
                    ...
                    <a href="{{ route('login') }}" class="text-primary hover:text-blue-300 transition-colors duration-300">Login</a>
                </p>
                <p class="mt-2">
